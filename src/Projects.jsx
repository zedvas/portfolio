  ...
  return (
    <div className="projects">
      ...
      <Card
        ...
        title={"HoliDough"}
        description={"A full-stack holiday budgeting application that allows users to manage, track, and predict expenses, with graphs for visual budget tracking"}
        tools={["React", "Redux","Node.js", "Express.js", "Axios", "MySQL", "Joi", "SASS", "Material UI"]}
